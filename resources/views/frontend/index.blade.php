...
<!-- Mirrored from avehtml.liquid-themes.com/index-seo.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Apr 2020 09:25:27 GMT -->
...
<link rel="stylesheet" href="../use.typekit.net/scc6wwx.css">
<link href="https://fonts.googleapis.com/css?family=Libre+Baskerville&amp;display=swap" rel="stylesheet">
<link rel="stylesheet" href="{{URL::asset('frontend/assets/vendors/liquid-icon/liquid-icon.min.css')}}" />
<link rel="stylesheet" href="{{URL::asset('frontend/assets/vendors/font-awesome/css/font-awesome.min.css')}}" />
<link rel="stylesheet" href="{{URL::asset('frontend/assets/css/theme-vendors.min.css')}}" />
<link rel="stylesheet" href="{{URL::asset('frontend/assets/css/theme.min.css')}}" />
<link rel="stylesheet" href="{{URL::asset('frontend/assets/css/themes/seo.css')}}" />

<script async src="{{URL::asset('frontend/assets/vendors/modernizr.min.js')}}"></script>
</head>
...
<img class="logo-dark" src="{{URL::asset('frontend/assets/img/logo/logo-1.svg')}}" alt="Ave HTML Template">
<img class="logo-sticky" src="{{URL::asset('frontend/assets/img/logo/logo-1.svg')}}" alt="Ave HTML Template">
<img class="mobile-logo-default" src="{{URL::asset('frontend/assets/img/logo/logo-1.svg')}}" alt="Ave HTML Template">
<img class="logo-default" src="{{URL::asset('frontend/assets/img/logo/logo-1.svg')}}" alt="Ave HTML Template">
</span>
</a>
...
<section class="vc_row bg-no-repeat fullheight d-flex align-items-center py-5" style="background-image: url('{{asset('frontend/assets/demo/bg/bg-75.svg')}}'); background-position: 170% 110%;">
...
<span class="ld-fh-txt"> With Ave, all over the place becomes all-in-one place. Every part of a project lifecycle is here.</span>
</p>
</div>
<div class="row">
...
<a href="https://www.youtube.com/watch?v=LjaKHqDbzSA" class="btn btn-naked text-uppercase fresco">
<span>
...
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/phone-1.png')}}" alt="Mobile Phone" />
</figure>
</div>
</div>
</div>
...
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/laptop-1.png')}}" alt="Laptop" />
</figure>
</div>
</div>
</div>
...
<figure>
<img src="{{URL::asset('frontend/assets/demo/clients/client-8.png')}}" alt="Client">
</figure>
</div>
<div class="lqd-column w-20 text-center px-2">
<figure>
<img src="{{URL::asset('frontend/assets/demo/clients/client-9.png')}}" alt="Client">
</figure>
</div>
<div class="lqd-column w-20 text-center px-2">
<figure>
<img src="{{URL::asset('frontend/assets/demo/clients/client-10.png')}}" alt="Client">
</figure>
</div>
<div class="lqd-column w-20 text-center px-2">
<figure>
<img src="{{URL::asset('frontend/assets/demo/clients/client-11.png')}}" alt="Client">
</figure>
</div>
<div class="lqd-column w-20 text-center px-2">
<figure>
<img src="{{URL::asset('frontend/assets/demo/clients/client-12.png')}}" alt="Client">
</figure>
</div>
<div class="lqd-column w-20 text-center px-2">
<figure>
...
<section id="about" class="vc_row bg-no-repeat pt-150 pb-150" style="background-image: url('{{asset('frontend/assets/demo/bg/bg-76.svg')}}'); background-position: -90% 80%;">
<div class="container">
...
<div class="contents">
<h3>Idea &amp; Concept</h3>
<p><span style="font-size: 18px;line-height: 30px">Introduction and kick-off meeting checklist. Lorem ispumdolor sit amet.</span></p>
</div>
</div>
</div>
<div class="lqd-column col-md-4">
...
<div class="liquid-img-group-container lqd-parallax-images-8" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":".liquid-img-group-single", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "direction":"backward", "initValues":{"translateX":-85, "opacity":0}, "animations":{"translateX":0, "opacity":1}}'>
<div class="liquid-img-group-inner">
<div class="liquid-img-group-single" data-shadow-style="4" data-roundness="8" data-inview="true" data-animate-shadow="true">
<div class="liquid-img-group-img-container">
...
<figure class="w-90">
<img src="{{URL::asset('frontend/assets/demo/misc/fi-7.jpg')}}" alt="Working with Ave" />
</figure>
</div>
</div>
</div>
...
<a href="https://www.youtube.com/watch?v=vKSA_idPZkc" class="btn btn-naked fresco btn-icon-block btn-icon-top btn-icon-xlg btn-icon-circle btn-icon-solid">
<span>
...
<figure>
<img src="/frontend/assets/demo/misc/fi-8.jpg" alt="Working with Ave" />
</figure>
</div>
</div>
</div>
...
<div data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "direction":"forward", "initValues":{"translateY":30, "opacity":0}, "animations":{"translateY":0, "opacity":1}}' class="lqd-column col-md-5 col-md-offset-1">
<header class="fancy-title mb-50">
<h6 class="text-uppercase">About us</h6>
<h2 class="lh-1 mb-0" data-fittext="true" data-fittext-options='{"compressor":0.65, "maxFontSize":"72", "minFontSize":"48"}'><strong>good</strong> design</h2>
<h2 class="lh-1 mb-0" data-fittext="true" data-fittext-options='{"compressor":0.65, "maxFontSize":"72", "minFontSize":"48"}'><strong>good</strong> business</h2>
</header>
<p class="font-size-30 lh-105"><i>We know that good design means good business.</i></p>
<p class="font-size-18 lh-15 mb-55">We help our clients succeed by creating brand identities, digital experiences, and print materials that communicate clearly, achieve marketing goals, and look fantastic.</p>
<a href="#" class="btn btn-solid text-uppercase btn-md circle btn-bordered border-thin btn-gradient font-weight-bold px-2" data-localscroll="true" data-localscroll-options='{"scrollBelowSection":true}'>
<span>
<span class="btn-gradient-bg"></span>
...
<section id="services" class="vc_row pt-90 pb-90 bg-no-repeat" style="background-image: url('{{asset('frontend/assets/demo/bg/bg-77.svg')}}'); background-position: 500% 0%;">
<div class="container">
<div class="row d-flex flex-wrap align-items-center">
...
<p class="font-size-18 lh-15 mb-55">We provide digital experience services to startups and small businesses to looking for a partner of their digital media, design & development, lead generation and communications requirents. We work with you, not for you. Although we have a great resources</p>
<a href="#" class="btn btn-solid text-uppercase btn-md circle btn-bordered border-thin btn-gradient font-weight-bold px-2" data-localscroll="true" data-localscroll-options='{"scrollBelowSection":true}'>
<span>
<span class="btn-gradient-bg"></span>
...
<path filter="url(#filter-seo-icon-4)" d="M26.313,28.406l-8.531-5.719L9.25,28.406V0H26.313V28.406h0Zm-14.25-5.25,5.719-3.937L23.5,23.156V2.813H12.063V23.156h0ZM43.188,2.813H29.031V5.625H40.375v36.75H3.625V5.625H6.438V2.813H0.813V45.188H43.188V2.813h0Z" transform="translate(-0.813)" />
</svg>
</span>
</div>
<div class="contents">
<h3>Branding</h3>
<p class="font-size-16 lh-165">Introduction and kick-off meeting checklist. Lorem ispumdolor sit amet.</p>
</div>
</div>
<div class="iconbox text-left iconbox-round iconbox-lg iconbox-filled iconbox-filled iconbox-filled-hover iconbox-icon-image iconbox-shadow pt-50 pb-40">
<div class="iconbox-icon-wrap">
...
<path filter="url(#filter-seo-icon-6)" d="M0,0.813H48V43.188H0V0.813H0ZM45.188,9.25V3.625H37.781L44.438,9.25h0.75ZM24.656,17.781h8.25l6.656-5.625h-8.25l-6.656,5.625h0ZM19.219,9.25h8.25L20.813,3.625h-8.25L19.219,9.25h0ZM27,12.156H18.75l-6.656,5.625h8.25L27,12.156h0ZM31.781,9.25h8.25L33.375,3.625h-8.25L31.781,9.25h0ZM2.813,3.625V9.25h12L8.156,3.625H2.813Zm0,8.531v5.625H7.688l6.656-5.625H2.813ZM45.188,40.375V20.594H2.813V40.375H45.188Zm0-22.594V12.156H43.969l-6.656,5.625h7.875Z" transform="translate(0 -0.813)" />
</svg>
</span>
</div>
<div class="contents">
...
<div class="row liquid-portfolio-list-row" data-liquid-masonry="true" data-masonry-options='{ "filtersID": "#seo-pf-grid" }' data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":".ld-pf-item","animateTargetsWhenVisible":"true","duration":"1600","delay":"160","easing":"easeOutQuint","initValues":{"translateY":65,"opacity":0},"animations":{"translateY":0,"opacity":1}}'>
...
<img src="/frontend/assets/demo/portfolio/pf-56.jpg" alt="Oblivision" />
</figure>
</div>
...
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Oblivion</h3>
...
<div class="ld-pf-image">
<figure data-responsive-bg="true" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
<img src="/frontend/assets/demo/portfolio/pf-57.jpg" alt="Oblivision" />
</figure>
</div>
<div class="ld-pf-details py-3">
<div class="ld-pf-bg" style="background-color: #fff;" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": "this", "easing": "easeInOutCirc", "duration": 850, "offDuration": 700, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
...
<div class="ld-pf-details-inner" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "easing": "easeOutQuint", "duration": 850, "offDuration": 750, "startDelay": 280, "offDelay": 280, "delay": 60, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Abstract</h3>
...
<div class="ld-pf-image">
<figure data-responsive-bg="true" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
<img src="/frontend/assets/demo/portfolio/pf-58.jpg" alt="Oblivision" />
</figure>
</div>
<div class="ld-pf-details py-3">
<div class="ld-pf-bg" style="background-color: #fff;" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": "this", "easing": "easeInOutCirc", "duration": 850, "offDuration": 700, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
...
<div class="ld-pf-details-inner" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "easing": "easeOutQuint", "duration": 850, "offDuration": 750, "startDelay": 280, "offDelay": 280, "delay": 60, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Creative Tropical</h3>
...
<div class="col-md-4 col-sm-6 col-xs-12 masonry-item digital-design grid-hover-overlay">
<article class="ld-pf-item ld-pf-dark pf-bg-shadow pf-details-visible pf-details-boxed pf-details-pull-right pf-details-pull-up-half title-size-24 pf-details-h-str pf-details-v-end post-2021 liquid-portfolio type-liquid-portfolio status-publish format-gallery has-post-thumbnail hentry post_format-post-format-gallery liquid-portfolio-category-branding liquid-portfolio-category-digital-design liquid-portfolio-category-grid-hover-overlay">
<div class="ld-pf-inner">
<div class="ld-pf-image">
<figure data-responsive-bg="true" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
<img src="/frontend/assets/demo/portfolio/pf-59.jpg" alt="Oblivision" />
</figure>
</div>
<div class="ld-pf-details py-3">
<div class="ld-pf-bg" style="background-color: #fff;" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": "this", "easing": "easeInOutCirc", "duration": 850, "offDuration": 700, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
...
<div class="ld-pf-details-inner" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "easing": "easeOutQuint", "duration": 850, "offDuration": 750, "startDelay": 280, "offDelay": 280, "delay": 60, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Falling Show</h3>
...
<div class="col-md-4 col-sm-6 col-xs-12 masonry-item custom-print digital-design grid-hover-overlay">
<article class="ld-pf-item ld-pf-dark pf-bg-shadow pf-details-visible pf-details-boxed pf-details-pull-right pf-details-pull-up-half title-size-24 pf-details-h-str pf-details-v-end post-2021 liquid-portfolio type-liquid-portfolio status-publish format-gallery has-post-thumbnail hentry post_format-post-format-gallery liquid-portfolio-category-branding liquid-portfolio-category-digital-design liquid-portfolio-category-grid-hover-overlay">
<div class="ld-pf-inner">
<div class="ld-pf-image">
<figure data-responsive-bg="true" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
<img src="frontend/assets/demo/portfolio/pf-60.jpg" alt="Oblivision" />
</figure>
</div>
<div class="ld-pf-details py-3">
<div class="ld-pf-bg" style="background-color: #fff;" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": "this", "easing": "easeInOutCirc", "duration": 850, "offDuration": 700, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
...
<div class="ld-pf-details-inner" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "easing": "easeOutQuint", "duration": 850, "offDuration": 750, "startDelay": 280, "offDelay": 280, "delay": 60, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Kama Headphone</h3>
...
<div class="ld-pf-image">
<figure data-responsive-bg="true" data-parallax="true" data-parallax-options='{ "parallaxBG": true }'>
<img src="frontend/assets/demo/portfolio/pf-61.jpg" alt="Oblivision" />
</figure>
</div>
<div class="ld-pf-details py-3">
<div class="ld-pf-bg" style="background-color: #fff;" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": "this", "easing": "easeInOutCirc", "duration": 850, "offDuration": 700, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
...
<div class="ld-pf-details-inner" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "easing": "easeOutQuint", "duration": 850, "offDuration": 750, "startDelay": 280, "offDelay": 280, "delay": 60, "initValues": { "translateY": 0 }, "animations": { "translateY": -70 } }'>
<h3 class="ld-pf-title h4" data-split-text="true" data-split-options='{ "type": "lines" }'>Super Water</h3>
...
<div class="liquid-counter liquid-counter-default liquid-counter-lg text-center text-sm-left">
<div class="liquid-counter-element text-black" data-enable-counter="true" data-counter-options='{"targetNumber":"2520","blurEffect":false}'>
<span>2520</span>
</div>
<span class="liquid-counter-text liquid-text-bottom text-primary">PROJECTS DONE</span>
</div>
</div>
<div class="col-md-3 col-sm-6 text-center text-sm-left">
<div class="liquid-counter liquid-counter-default liquid-counter-lg text-center text-sm-left">
<div class="liquid-counter-element text-black" data-enable-counter="true" data-counter-options='{"targetNumber":"615","blurEffect":false}'>
<span>615</span>
</div>
<span class="liquid-counter-text liquid-text-bottom text-primary">HAPPY CUSTOMERS</span>
</div>
</div>
<div class="col-md-3 col-sm-6 text-center text-sm-left">
<div class="liquid-counter liquid-counter-default liquid-counter-lg text-center text-sm-left">
<div class="liquid-counter-element text-black" data-enable-counter="true" data-counter-options='{"targetNumber":"102","blurEffect":false}'>
<span>102</span>
</div>
<span class="liquid-counter-text liquid-text-bottom text-primary">WINNING AWWARDS</span>
</div>
</div>
<div class="col-md-3 col-sm-6 text-center text-sm-left">
<div class="liquid-counter liquid-counter-default liquid-counter-lg text-center text-sm-left">
<div class="liquid-counter-element text-black" data-enable-counter="true" data-counter-options='{"targetNumber":"3,200","blurEffect":false}'>
<span>3,200</span>
</div>
<span class="liquid-counter-text liquid-text-bottom text-primary">EMPLOYEES WORLDWIDE</span>
</div>
</div>
</div>
</div>
</section>
<section class="vc_row bg-no-repeat bg-sm-none pt-90 pb-50" style="background-image: url('{{asset('frontend/assets/demo/bg/bg-78.svg')}}'); background-position: 12% 35%;">
<div class="container">
<div class="row">
<div class="lqd-column col-md-4 visible-xs visible-sm text-center">
<div class="ld-fancy-heading mask-text">
<h6 class="mb-0 font-weight-light lh-1" data-fittext="true" data-fittext-options='{"compressor":0.55,"maxFontSize":"100", "minFontSize":"100"}' data-split-text="true" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":".split-inner", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "direction":"forward", "initValues":{"translateX":90}, "animations":{"translateX":0}}' data-split-options='{"type":"chars, words"}'>
...
<div class="carousel-items row" data-lqd-flickity='{"wrapAround": true, "pageDots": true}'>
<div class="carousel-item col-xs-12 mb-9">
<p class="font-size-30 lh-16 text-black h4 mb-5">“A beautiful theme, with excellent scores on pingdom speed tool and gtmetrix, that is one of the main reasons for my purchase.“</p>
<h3 class="mt-0 mb-2">David Holand</h3>
<h5 class="my-0 opacity-06">Senior Project Manager at Spotify</h5>
</div>
<div class="carousel-item col-xs-12 mb-9">
<p class="font-size-30 lh-16 text-black h4 mb-5">“A beautiful theme, with excellent scores on pingdom speed tool and gtmetrix, that is one of the main reasons for my purchase.“</p>
<h3 class="mt-0 mb-2">David Holand</h3>
...
<div class="ld-fancy-heading mask-text">
<h6 class="mb-0 font-weight-light" data-fittext="true" data-fittext-options='{"compressor":0.55,"maxFontSize":"100", "minFontSize":"100"}' data-split-text="true" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":".split-inner", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "direction":"forward", "initValues":{"translateX":90}, "animations":{"translateX":0}}' data-split-options='{"type":"chars, words"}'>
<span class="ld-fh-txt"> 99</span>
</h6>
</div>
<header class="fancy-title pr-md-4">
...
<div class="liquid-img-group-single">
<div class="liquid-img-group-img-container">
<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":60}' data-parallax-to='{"translateY":-160}' data-parallax-options='{"overflowHidden":false,"easing":"linear"}'>
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/parallax-img-18.png')}}" alt="Avatar" />
</figure>
</div>
</div>
</div>
<div class="liquid-img-group-single">
<div class="liquid-img-group-img-container">
<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":130}' data-parallax-to='{"translateY":-125}' data-parallax-options='{"overflowHidden":false,"easing":"linear"}'>
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/parallax-img-19.png')}}" alt="Avatar" />
</figure>
</div>
</div>
</div>
<div class="liquid-img-group-single">
<div class="liquid-img-group-img-container">
<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":60}' data-parallax-to='{"translateY":-60}' data-parallax-options='{"overflowHidden":false,"easing":"linear"}'>
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/parallax-img-20.png')}}" alt="Avatar" />
 </figure>
</div>
</div>
</div>
<div class="liquid-img-group-single">
<div class="liquid-img-group-img-container">
<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":120}' data-parallax-to='{"translateY":-265}' data-parallax-options='{"overflowHidden":false,"easing":"linear"}'>
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/parallax-img-21.png')}}" alt="Avatar" />
</figure>
</div>
</div>
</div>
<div class="liquid-img-group-single">
<div class="liquid-img-group-img-container">
<div class="liquid-img-container-inner" data-parallax="true" data-parallax-from='{"translateY":40}' data-parallax-to='{"translateY":-90}' data-parallax-options='{"overflowHidden":false,"easing":"linear"}'>
<figure>
<img src="{{URL::asset('frontend/assets/demo/misc/parallax-img-22.png')}}" alt="Avatar" />
</figure>
</div>
</div>
</div>
...
<section id="pricing" class="vc_row bg-cover pt-60 pb-100" style="background-image: url('{{asset('frontend/assets/demo/bg/bg-79.svg')}}'); background-position: center top;">
<div class="container">
<div class="row">
<div class="lqd-column col-md-12">
<header class="fancy-title text-center mb-90">
<h6 class="text-uppercase">Pricing plan</h6>
<h2><strong>Affordable</strong> pricing</h2>
</header>
</div>
</div>
<div class="row mx-md-0">
<div class="lqd-column col-md-4 px-md-0">
<div class="pricing-table pricing-table-agency">
<div class="pricing-table-header">
<figure class="mb-7 loaded">
<img src="{{URL::asset('frontend/assets/demo/misc/pricing-table-1.png')}}" alt="Personal Plan" />
</figure>
<h5>Personal</h5>
<p class="pricing"><sup>$</sup>9.99<small>month</small></p>
</div>
<div class="pricing-table-body">
<ul>
<li>Custome Domains</li>
<li>Sleep after 30 mins ofactivity</li>
</ul>
</div>
<div class="pricing-table-footer">
<a href="#" class="btn btn-default text-uppercase btn-sm circle btn-bordered border-thin font-size-14 font-weight-bold ltr-sp-05 px-2">
<span>
...
<span class="pricing-table-featured-label font-weight-bold text-uppercase ltr-sp-25"><span>Popular</span></span>
<div class="pricing-table-header">
<figure class="mb-7 loaded">
<img src="{{URL::asset('frontend/assets/demo/misc/pricing-table-2.png')}}" alt="Small Team Plan" />
</figure>
<h5>Small Team</h5>
<p class="pricing"><sup>$</sup>49.99<small>month</small></p>
</div>
<div class="pricing-table-body">
<ul>
<li>Never sleeps</li>
<li>Multiple workers for morepowerful apps</li>
</ul>
</div>
<div class="pricing-table-footer">
<a href="#" class="btn btn-default text-uppercase btn-sm circle btn-solid border-thin font-size-14 font-weight-bold ltr-sp-05 px-2">
<span>
<span class="btn-txt">Get started now</span>
</span>
</a>
...
<div class="pricing-table-header">
<figure class="mb-7 loaded">
<img src="{{URL::asset('frontend/assets/demo/misc/pricing-table-3.png')}}" alt="Small Team Plan" />
</figure>
<h5>Enterprise</h5>
<p class="pricing"><sup>$</sup>99.99<small>month</small></p>
</div>
<div class="pricing-table-body">
<ul>
<li>Dedicated</li>
<li>Simple horizontalscalability</li>
</ul>
</div>
<div class="pricing-table-footer">
<a href="#" class="btn btn-default text-uppercase btn-sm circle btn-bordered border-thin font-size-14 font-weight-bold ltr-sp-05 px-2">
...
<a href="#">
<img src="{{URL::asset('frontend/assets/demo/blog/blog-6.jpg')}}" alt="Blog Post">
</a>
</figure>
...
<figure class="liquid-lp-media rounded">
<a href="#">
<img src="{{URL::asset('frontend/assets/demo/blog/blog-7.jpg')}}" alt="Blog Post">
</a>
</figure>
<header class="liquid-lp-header">
<h2 class="entry-title liquid-lp-title h5">
...
<figure class="liquid-lp-media rounded">
<a href="#">
<img src="{{URL::asset('frontend/assets/demo/blog/blog-8.jpg')}}" alt="Blog Post">
</a>
</figure>
<header class="liquid-lp-header">
<h2 class="entry-title liquid-lp-title h5">
...
<div class="lqd-column col-md-3 col-xs-6 mb-30">
<h3 class="widget-title">Branded eCommerce</h3>
<ul class="lqd-custom-menu reset-ul font-size-14 lh-2">
...
<div class="lqd-column col-md-3 col-xs-6 mb-30">
<h3 class="widget-title">Branding Strategy</h3>
<ul class="lqd-custom-menu reset-ul font-size-14 lh-2">
...
<figure class="mr-3">
<img src="{{URL::asset('frontend/assets/img/logo/logo-1.svg')}}" alt="Ave Logo">
</figure>
<p class="font-size-16 my-0">Copyright 2019 <span class="text-secondary font-weight-bold">Ave</span>. All Rights Reserved.</p>
</div>
...
<script src="{{URL::asset('frontend/assets/js/theme-vendors.js')}}"></script>
<script src="{{URL::asset('frontend/assets/js/theme.min.js')}}"></script>
<script src="{{URL::asset('frontend/assets/js/liquidAjaxMailchimp.min.js')}}"></script>
</body>

<!-- Mirrored from avehtml.liquid-themes.com/index-seo.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Apr 2020 09:26:10 GMT -->
</html>